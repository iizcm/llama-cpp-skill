...
cp -r mlops/inference/llama-cpp ~/.hermes/skills/mlops/inference/llama-cpp/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/llama-cpp-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/llama-cpp-skill.git ~/.hermes/skills/mlops/inference/llama-cpp/
```
...
```text
skill_view(name="mlops/inference/llama-cpp")
```
...
```text
Use the llama cpp skill to <describe your specific task here>
```
...
```text
Gunakan skill llama cpp untuk <deskripsikan tugas spesifik Anda di sini>
```
